					...
					{
						{
							...
							image = gears.color.recolor_image(icon_dir .. "ram.svg", color["nord0"]),
							resize = false,
						},
						id = "icon_layout",

...
return gears.table.join(
	...
	awful.key({ modkey }, "#27", function()
		awful.spawn("rofi -show run -show-icons -icon-theme \"Papirus-Dark\" -theme .local/share/rofi/themes/nord-round.rasi")
	end, { descripton = "Run", group = "Applications" }),
	awful.key({ modkey }, "#40", function()
		awful.spawn("rofi -show drun -show-icons -icon-theme \"Papirus-Dark\" -theme .local/share/rofi/themes/nord-full.rasi")
	end, { descripton = "Application launcher", group = "Applications" }),
	awful.key({ "Mod1" }, "#23", function()
		awful.spawn("rofi -show window -show-icons -icon-theme \"Papirus-Dark\" -theme .local/share/rofi/themes/nord-round.rasi")

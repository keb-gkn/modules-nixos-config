...
return gears.table.join(
	...
	awful.key({ modkey, "Control" }, "#27", awesome.restart, { description = "Reload awesome", group = "Awesome" }),
	...
	awful.key({ modkey }, "#27", function()
		awful.spawn("rofi -show run -show-icons -icon-theme \"Papirus-Dark\" -theme $HOME/.local/share/rofi/themes/nord-round.rasi")
	end, { descripton = "Run", group = "Applications" }),
	awful.key({ modkey }, "#40", function()
		awful.spawn("rofi -show drun -show-icons -icon-theme \"Papirus-Dark\" -theme $HOME/.local/share/rofi/themes/nord-full.rasi")
	end, { descripton = "Application launcher", group = "Applications" }),
	awful.key({ "Mod1" }, "#23", function()
		awful.spawn("rofi -show window -show-icons -icon-theme \"Papirus-Dark\" -theme $HOME/.local/share/rofi/themes/nord-round.rasi")
	...
	end, { descripton = "Session options", group = "System" }),
	...
	awful.key({}, "XF86MonBrightnessUp", function(c)
		...
		awful.spawn.easy_async_with_shell("pkexec xfpm-power-backlight-helper --get-brightness", function(stdout)
			awful.spawn.easy_async_with_shell(
				"pkexec xfpm-power-backlight-helper --set-brightness " .. tostring(tonumber(stdout) + BACKLIGHT_SEPS),
				function(stdou2) end
			)

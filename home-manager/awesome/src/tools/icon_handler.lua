...
function Get_icon(theme, client, program_string, class_string, is_steam)
  ...
  if theme and (client or program_string or class_string) then
    ...
    elseif client then
      ...
      elseif client.name then
        ...
        if client.icon then
          ...
          return "/run/current-system/sw/share/icons/Papirus-Dark/128x128/apps/application-default-icon.svg"
        end
      end
    else
    ...
    for _, res in ipairs(resolutions) do
      local iconDir = "/run/current-system/sw/share/icons/" .. theme .. "/" .. res .. "/apps/"
      ...
      if ioStream ~= nil then
        ...
        iconDir = "/run/current-system/sw/share/icons/" .. theme .. "/" .. res .. "/apps/"
